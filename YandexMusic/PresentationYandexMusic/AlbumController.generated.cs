...
namespace PresentationYandexMusic.Controllers
{
    public partial class AlbumController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ViewResult AlbumDetail()
        {
            return new T4MVC_System_Web_Mvc_ViewResult(Area, Name, ActionNames.AlbumDetail);
        }
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string AlbumDetail = "AlbumDetail";
        }
        ...
        public class ActionNameConstants
        {
            ...
            public const string AlbumDetail = "AlbumDetail";
        }
        ...
        static readonly ActionParamsClass_AlbumDetail s_params_AlbumDetail = new ActionParamsClass_AlbumDetail();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_AlbumDetail AlbumDetailParams { get { return s_params_AlbumDetail; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_AlbumDetail
        {
            public readonly string id = "id";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string AlbumDetail = "~/Views/Album/AlbumDetail.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AlbumController : PresentationYandexMusic.Controllers.AlbumController
    {
        ...
        [NonAction]
        partial void AlbumDetailOverride(T4MVC_System_Web_Mvc_ViewResult callInfo, int id);

        [NonAction]
        public override System.Web.Mvc.ViewResult AlbumDetail(int id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ViewResult(Area, Name, ActionNames.AlbumDetail);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            AlbumDetailOverride(callInfo, id);
            return callInfo;
        }
